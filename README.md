...
2. **Экспорт отчетов:**  
   При большом объеме данных генерацию PDF-отчета ТОП-10 также целесообразно вынести в фоновый джоб (`GenerateReportJob`), а пользователю показывать статус "Формируется" с последующей отправкой ссылки на скачивание.
